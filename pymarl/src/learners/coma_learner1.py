...
class COMALearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        with th.no_grad():
            obs = batch["obs"][:, :-1]
            social_contribution_index = self.redistribution_model.calculate_social_contribution_index(obs, actions[:, :-1])
        ...
        q_vals, critic_train_stats = self._train_critic(batch, redistributed_rewards, terminated, actions, avail_actions,
